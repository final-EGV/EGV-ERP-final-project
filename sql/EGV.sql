...
INSERT INTO EGV.ANNUAL_LEAVE 
(AL_CODE,EMP_CODE,AL_YEAR,AL_COUNT,AL_USE_COUNT) 
VALUES
(1,'2021100',2021,15,13);

Insert into EGV.ANNUAL_LEAVE (AL_CODE,EMP_CODE,AL_YEAR,AL_COUNT,AL_USE_COUNT) values (1,'2021100',2021,15,13);
Insert into EGV.ANNUAL_LEAVE (AL_CODE,EMP_CODE,AL_YEAR,AL_COUNT,AL_USE_COUNT) values (2,'2021101',2021,20,3);
Insert into EGV.ANNUAL_LEAVE (AL_CODE,EMP_CODE,AL_YEAR,AL_COUNT,AL_USE_COUNT) values (3,'2021102',2021,16,7);
Insert into EGV.ANNUAL_LEAVE (AL_CODE,EMP_CODE,AL_YEAR,AL_COUNT,AL_USE_COUNT) values (4,'2021103',2021,16,10);
Insert into EGV.ANNUAL_LEAVE (AL_CODE,EMP_CODE,AL_YEAR,AL_COUNT,AL_USE_COUNT) values (5,'2021104',2021,19,7);
Insert into EGV.ANNUAL_LEAVE (AL_CODE,EMP_CODE,AL_YEAR,AL_COUNT,AL_USE_COUNT) values (6,'2021105',2021,20,14);
...
CREATE TABLE USE_ANNUAL_LEAVE (
    ...
    ANNUAL_LEAVE_CODE NUMBER,
    EMP_CODE VARCHAR2(255),
    UAL_START_DATE DATE NOT NULL,
    UAL_END_DATE DATE NOT NULL,
    TOTAL_DATE NUMBER,
    ...
    COMMENT ON COLUMN USE_ANNUAL_LEAVE.UAL_START_DATE IS '연차사용시작날짜';
    COMMENT ON COLUMN USE_ANNUAL_LEAVE.UAL_END_DATE IS '연차사용종료날짜';
    COMMENT ON COLUMN USE_ANNUAL_LEAVE.TOTAL_DATE IS '총 연가일수';
    COMMENT ON COLUMN USE_ANNUAL_LEAVE.UAL_CONTENT IS '연차내용';

Insert into EGV.USE_ANNUAL_LEAVE (UAL_CODE,ANNUAL_LEAVE_CODE,EMP_CODE,UAL_START_DATE,UAL_END_DATE,UAL_CONTENT, TOTAL_DATE) values (1,1,'2021100',to_date('21-12-01','RR-MM-DD'),to_date('21-12-03','RR-MM-DD'),'여름휴가', 3);
...
CREATE TABLE OFFICIAL (
  ...
  OFFICIAL_DATE DATE DEFAULT SYSDATE NOT NULL,
  EMP_CODE VARCHAR2(255),
  -- COLUMN LEVEL CONSTRAINT
...
INSERT INTO THEATER VALUES(SEQ_THEATER_CODE.NEXTVAL, '프리미엄 1관', 24);
INSERT INTO THEATER VALUES(SEQ_THEATER_CODE.NEXTVAL, '프리미엄 2관', 24);
INSERT INTO THEATER VALUES(SEQ_THEATER_CODE.NEXTVAL, '일반 3관', 280);
INSERT INTO THEATER VALUES(SEQ_THEATER_CODE.NEXTVAL, '일반 4관', 280);
INSERT INTO THEATER VALUES(SEQ_THEATER_CODE.NEXTVAL, '일반 5관', 150);
INSERT INTO THEATER VALUES(SEQ_THEATER_CODE.NEXTVAL, '일반 6관', 150);
--INSERT INTO THEATER VALUES(SEQ_THEATER_CODE.NEXTVAL, '일반 7관', 150);
--INSERT INTO THEATER VALUES(SEQ_THEATER_CODE.NEXTVAL, '일반 8관', 150);
...
CREATE TABLE EVENT (
  ...
  START_DATETIME VARCHAR2(16) NOT NULL,
  END_DATETIME VARCHAR2(16) NOT NULL,
...
CREATE TABLE SCREENING_SCHEDULE (
  ...
  MOVIE_CODE NUMBER NOT NULL,
  THEATER_CODE NUMBER NOT NULL,
  SCREENING_START VARCHAR2(16) NOT NULL,
  SCREENING_END VARCHAR2(16) NOT NULL,
  -- COLUMN LEVEL CONSTRAINT
...
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 8, 1, '2021-12-09T10:30', '2021-12-09T12:18');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 10, 1, '2021-12-09T12:48', '2021-12-09T14:37');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 10, 1, '2021-12-09T15:06', '2021-12-09T16:55');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 10, 1, '2021-12-09T17:25', '2021-12-09T19:14');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 10, 1, '2021-12-09T19:44', '2021-12-09T21:33');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 8, 1, '2021-12-09T22:03', '2021-12-09T23:51');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 8, 1, '2021-12-10T00:21', '2021-12-10T02:09');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 11, 2, '2021-12-09T10:35', '2021-12-09T12:39');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 11, 2, '2021-12-09T13:09', '2021-12-09T15:13');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 9, 2, '2021-12-09T15:43', '2021-12-09T17:17');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 9, 2, '2021-12-09T17:47', '2021-12-09T19:21');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 11, 2, '2021-12-09T19:51', '2021-12-09T21:55');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 11, 2, '2021-12-09T22:25', '2021-12-10T00:29');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 3, 3, '2021-12-09T11:00', '2021-12-09T13:35');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 9, 3, '2021-12-09T13:50', '2021-12-09T15:24');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 13, 3, '2021-12-09T15:39', '2021-12-09T17:35');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 9, 3, '2021-12-09T17:50', '2021-12-09T19:24');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 13, 3, '2021-12-09T19:39', '2021-12-09T21:35');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 3, 3, '2021-12-09T21:50', '2021-12-10T00:25');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 15, 4, '2021-12-09T10:00', '2021-12-09T12:24');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 14, 4, '2021-12-09T12:39', '2021-12-09T14:50');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 12, 4, '2021-12-09T15:05', '2021-12-09T17:05');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 13, 4, '2021-12-09T17:20', '2021-12-09T19:16');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 9, 4, '2021-12-09T19:31', '2021-12-09T21:05');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 5, 4, '2021-12-09T21:20', '2021-12-09T23:55');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 10, 5, '2021-12-09T10:30', '2021-12-09T12:19');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 11, 5, '2021-12-09T12:34', '2021-12-09T14:38');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 13, 5, '2021-12-09T14:53', '2021-12-09T16:49');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 8, 5, '2021-12-09T17:04', '2021-12-09T18:52');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 15, 5, '2021-12-09T19:07', '2021-12-09T21:18');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 16, 5, '2021-12-09T21:33', '2021-12-09T23:51');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 5, 6, '2021-12-09T10:20', '2021-12-09T12:55');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 6, 6, '2021-12-09T13:10', '2021-12-09T15:09');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 9, 6, '2021-12-09T15:24', '2021-12-09T16:58');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 10, 6, '2021-12-09T17:13', '2021-12-09T19:02');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 11, 6, '2021-12-09T19:17', '2021-12-09T21:21');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 12, 6, '2021-12-09T21:36', '2021-12-09T23:36');
INSERT INTO SCREENING_SCHEDULE (SCREENING_CODE, MOVIE_CODE, THEATER_CODE, SCREENING_START, SCREENING_END) VALUES (SEQ_SCREENING_CODE.NEXTVAL, 9, 6, '2021-12-09T23:51', '2021-12-10T01:25');
