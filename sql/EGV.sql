...
CREATE TABLE USE_ANNUAL_LEAVE (
    ...
    COMMENT ON COLUMN USE_ANNUAL_LEAVE.AL_CATEGORY_CODE IS '연차카테고리코드';
    COMMENT ON COLUMN USE_ANNUAL_LEAVE.EMP_CODE IS '사번';
    COMMENT ON COLUMN USE_ANNUAL_LEAVE.UAL_DATE_START IS '연차사용 시작날짜';
    COMMENT ON COLUMN USE_ANNUAL_LEAVE.UAL_DATE_END IS '연차사용 종료날짜';
