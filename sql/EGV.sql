...
CREATE TABLE PARTTIME_SCHEDULE (
    ...
    EMP_CODE NUMBER CONSTRAINT NN_EMP_CODE NOT NULL,
...
CREATE TABLE EGV_WORK (
      ...
      WORK_START DATE CONSTRAINT NN_WORK_START NOT NULL,
      WORK_END DATE CONSTRAINT NN_WORK_END NOT NULL,
      WORK_OVER DATE,
      -- TABLE LEVEL CONSTRAINT
...
CREATE TABLE SALARY (
    -- COLUMN LEVEL CONSTRAINT
    SAL_CODE NUMBER,
    EMP_CODE NUMBER CONSTRAINT NN_EMP_CODE2 NOT NULL,
    SAL_MONTH DATE,
...
COMMENT ON COLUMN EVENT.EVENT_DATE IS '이벤트일자';
COMMENT ON COLUMN EVENT.EVENT_START IS '시작시간';
COMMENT ON COLUMN EVENT.EVENT_END IS '종료시간';
COMMENT ON COLUMN EVENT.RENTAL_COMPANY IS '대관회사';
COMMENT ON COLUMN EVENT.MOVIE_CODE IS '영화코드';
COMMENT ON COLUMN EVENT.PRODUCT_CODE IS '이벤트상품코드(DEPRECATED)';
