...
CREATE SEQUENCE SEQ_PARTTIME_CODE;
...
CREATE TABLE PARTTIME_SCHEDULE (
    ...
    PARTTIME_DATE DATE CONSTRAINT NN_PARTTIME_DATE NOT NULL,
    ...
    COMMENT ON COLUMN PARTTIME_SCHEDULE.PARTTIME_DATE IS '날짜';
...
CREATE TABLE EGV_WORK (
      ...
      WORK_END TIMESTAMP CONSTRAINT NN_WORK_END NOT NULL,
      WORK_OVER NUMBER,
      -- TABLE LEVEL CONSTRAINT
...
VALUES
(
SEQ_WORK_CODE.NEXTVAL, 1, '2021100',
'2021-11-26', '2021-11-26 00:00:00', '2021-11-26 03:00:00', NULL
);
...
CREATE TABLE ANNUAL_LEAVE (
    ...
    CONSTRAINT FK_ANNUAL_LEAVE_CODE FOREIGN KEY(ANNUAL_LEAVE_CODE) REFERENCES ANNUAL_LEAVE_CATEGORY(ANNUAL_LEAVE_CODE)
);
    COMMENT ON COLUMN ANNUAL_LEAVE.AL_CODE IS '개인연차코드';
    COMMENT ON COLUMN ANNUAL_LEAVE.ANNUAL_LEAVE_CODE IS '연차카테고리코드';
...
TO_DATE('2021-11-26 00:00'), TO_DATE('2021-12-08 00:00'), null, 2, '캐릭터 에폭시 마그넷 11종');
INSERT INTO EVENT VALUES(SEQ_EVENT_CODE.NEXTVAL, '<이터널스> 도전! N차 관람',
TO_DATE('2021-11-03 00:00'), TO_DATE('2021-11-30 00:00'), null, 2, '오리지널 굿즈');
INSERT INTO EVENT VALUES(SEQ_EVENT_CODE.NEXTVAL, '<귀멸의 칼날: 남매의 연> 2주차 현장 경품 증정 이벤트',
TO_DATE('2021-11-17 00:00'), TO_DATE('2021-11-30 00:00'), null, 7, 'A3사이즈 포스터');
INSERT INTO EVENT VALUES(SEQ_EVENT_CODE.NEXTVAL, '<듄> Signature ART CARD No.50',
TO_DATE('2021-10-20 00:00'), TO_DATE('2021-11-30 00:00'), null, 3, '<듄> Signature Art Card');
INSERT INTO EVENT VALUES(SEQ_EVENT_CODE.NEXTVAL, '<고장난 론> Signature ART CARD No.51',
TO_DATE('2021-10-27 00:00'), TO_DATE('2021-11-30 00:00'), null, 3, '<고장난 론> Signature Art Card');
INSERT INTO EVENT VALUES(SEQ_EVENT_CODE.NEXTVAL, '<유체이탈자> 무대인사 이벤트',
TO_DATE('2021-11-27 00:00'), TO_DATE('2021-11-27 00:00'), '메가박스중앙(주)플러스엠', null, null);
INSERT INTO EVENT VALUES(SEQ_EVENT_CODE.NEXTVAL, '<장르만 로맨스> 무대인사 이벤트',
TO_DATE('2021-11-27 00:00'), TO_DATE('2021-11-27 00:00'), '넥스트엔터테인먼트월드', null, null);
INSERT INTO EVENT VALUES(SEQ_EVENT_CODE.NEXTVAL, '<연애 빠진 로맨스> 무대인사 이벤트',
TO_DATE('2021-11-27 00:00'), TO_DATE('2021-11-27 00:00'), 'CJENM', null, null);
INSERT INTO EVENT VALUES(SEQ_EVENT_CODE.NEXTVAL, '[한사랑산악회] 제12회 정기미팅 대관',
TO_DATE('2021-11-11 18:00'), TO_DATE('2021-11-11 21:00'), '한사랑산악회', null, null);
INSERT INTO EVENT VALUES(SEQ_EVENT_CODE.NEXTVAL, '[더조은] 자바A 스마트3회차 수료식',
TO_DATE('2021-12-08 14:00'), TO_DATE('2021-12-08 18:50'), '더조은컴퓨터아카데미', null, '수료증과 그의 손에 쥐어지는 합격 목걸이');
